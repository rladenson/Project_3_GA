...
const ShowProject = (props) => {
  ...
  const { project, currentUser } = location.state;
        ...
        <Col md={4}>
           <div className="profile-sideview">
            ...
            <div style={{ marginTop: "-60px" }}>
              <h3 className="title">{project.createdBy.name}</h3>
              <h6>{project.createdBy.title}</h6>
          ...
          <Card className="shadow-sm h-100">
            ...
            <Card.Body className="text-start">
              <Card.Title className="d-md-flex justify-content-between">
                ...
                <small>
                  <a style={{ textDecoration: "none" }} href={project.repolink}className="icon">
                    <i className="bi bi-github"> GitHub Repository</i>
                  </a>{" "}
                  <a style={{ textDecoration: "none" }} href={project.deployedlink} className="icon">
              ...
              <ListGroup className="list-group-flush">
                ...
                <ListGroup.Item>Created by {project.createdBy.name}</ListGroup.Item>
              </ListGroup>
